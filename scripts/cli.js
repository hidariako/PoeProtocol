...
const contractABI = require("../artifacts/contracts/Poeprotocol.sol/Poeprotocol.json").abi;

program
    .name("poeprotocol-cli")
    .description("CLI tool for Poeprotocol smart contract")
    .version("1.0.0");
