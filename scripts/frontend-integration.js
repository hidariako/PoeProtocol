 ...
 * This file demonstrates how to integrate Poeprotocol with a web frontend
 */

// For React/Vue/Angular applications
export class PoeprotocolClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PoeprotocolClient(provider, contractAddress);
